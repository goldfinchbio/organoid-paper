---
title: "Day 26 in vitro integration"
output:
  html_document:
    code_folding: hide
    collapsed: no
...
DOCNAME = "Day_26_in_vitro_integration"
...
annotations <- annotations %>% filter(grepl("day26", sample_name))
```
...
In this analysis we will perform integration, clustering and cell type identification of the 3 **Day 26 *in vitro* ** samples. 
...
cluster_id <- read_csv(here("data/cluster_IDs/in_vitro/day26_2.csv")) %>% mutate(Cluster = as.factor(Cluster))
