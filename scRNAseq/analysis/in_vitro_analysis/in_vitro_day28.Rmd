---
title: "Day 28 in vitro integration"
output:
  html_document:
    code_folding: hide
    collapsed: no
...
DOCNAME = "Day_28_in_vitro_integration"
...
annotations <- annotations %>% filter(grepl("day28", sample_name))
```
...
In this analysis we will perform integration, clustering and cell type identification of the 3 **Day 28 *in vitro* ** samples. 
...
cluster_id <- read_csv(here("data/cluster_IDs/in_vitro/day28_2.csv")) %>% mutate(Cluster = as.factor(Cluster))
